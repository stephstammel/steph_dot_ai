...
That's what [packetiseR](https://github.com/stephdesilva/packetiseR) is for. It breaks down very large csvs into smaller chunks, so that there are fewer missing packets to find in the same length of time before time out. It then reassembles them on the other side.
