...
__Content developed for and by the subculture__. The developing subculture produces more content than code for the use of analysts and analysis produced by R code. The developing subculture produces, both for its own consumption and those outside of it:
    ...
    * Visualisation as art both deliberately (see for example [the R Graph Gallery, Holtz (2017)](https://www.r-graph-gallery.com/portfolio/data-art/) or [Flowing Data (Yau, 2018)](http://flowingdata.com)), and accidentally, shared for appreciative purposes (see for example [accidental aRT (Woo and Mudrak 2018)](http://accidental-art.tumblr.com)).
    * Analysis for entertainment and general education, for example Robinson's (2016, 2017) [analysis of Trump's tweets](http://varianceexplained.org/r/trump-tweets/) and [Meek and Averick (2017)](https://archervisualization.herokuapp.com) (although the site was built in D3, analysis was also conducted in R).
    * Extensive educative materials and communities both for R, the programming language (see for example Bocek (2018), Maegan (2018) among many others), for the dynamic package sharing system, [such as Silge (2017)](https://juliasilge.com/blog/navigating-packages/) and for navigating the community itself, [such as Ellis (2017)](https://ropensci.org/blog/2017/06/23/community/).
    * Meta cultural content, created for the purpose of alerting the subculture to these resources, such as [R-Bloggers](https://www.r-bloggers.com), [R Weekly](https://www.rweekly.org), and many others
...
- R is a developing subculture as well as a programming language.
- Define subculture as per Hodkinson (2012), spectacular/distinctive
- Anheier et al. can exist at all levels of an org
- Elements of subculture include
    - shared institutions, each with their own purpose that assists the collective, e.g. CRAN, R Foundation, ROpensci, RLadies, R Core
    - Distinct philosophical and well developed ideaological concepts, e.g. tidyverse - a collection of packages _yes_, but also a very specific view of how programming can be streamlined by means of a grammar and the implications this has for widening the tool's appeal.
    - Content produced for appreciation/entertainment - art as viz
    - Content produced for education/informing members of the subculture within the community - blogs, documentation etc. Disseminated through the community by lots of means, RWeekly, twitter, meetups etc.
- Not unique among programmers/FOSS communities, c.f. Coleman's seminal work _Coding Freedom_
- Similarities to the Debian findings she notes:
  - Shared social commonwealth
...
- If there is a subculture developing, what does that _mean_ and is it even relevant to us?
- Why isn't it just about the code?
- This subculture is not unique, by any means. BUt it is particularly rich: sitting at the intersection of many different fields and domains. This creates a dynamic field for the development of _value_.
...
- A subculture is more than just a programming language. It brings value to the process of creation that extends beyond satellite programmers sitting alone and coding in paralell.
...
- The fact that R as a community/subculture has a very unique array of inputs is not surprising.
- The array of outputs from this subculture is extraordinary.
  - First stage outputs: improvements and add ons to R itself. Things like packages, utilities etc.
  - Second stage outputs: scientific, statistical and humanities work built in part using first stage outputs.
  - Third stage outputs: taking these scientific + other research outputs to create other objects of value in the community - business, government, scientific endeavour in the comunity etc.
  - Obviously lots of interplay between stages and they're neither consecutive or necessarily required. One piece of work can encompass all three.
- Why does this matter? Because productivity matters. Productivity is one of the ways that we can increase living standards for everone over all.
- What is productivity?
- Productivity has been lagging in the developed world [chart], but it's not even across industries by any means.
...
- A number of these R culture outputs translate into very substantive economic value further down the chain, just by the productivity increases they engender for users. They may seem prosaic, but because of the number of people they can help and apply to, they're huge!
